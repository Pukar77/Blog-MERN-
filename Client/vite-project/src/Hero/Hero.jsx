      ...
      <section className="dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex flex-col justify-center p-1 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className=" w-39 text-4xl font-bold leading-none sm:text-6xl ">
              Ali Ali Blog
              <br /> <br />
              <span className="dark:text-violet-600"></span>Lets start writing
            </h1>
            <p className="mt-6 mb-8 text-lg sm:mb-12">
              The place where we share
              <br />
              <br />
              <br className="hidden md:inline lg:hidden" />
              Wanna write, ali ali is best for you
            </p>
